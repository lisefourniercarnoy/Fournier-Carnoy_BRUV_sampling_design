...
# Data:    2024 DBCA (state) BRUV habitat data.
...
metadata <- read.csv(paste0("data/tidy/", name, sampling_design, "_tidy_metadata.csv")) %>%
...
aus <- st_read("data/spatial/shapefiles/WAcoastline.shp") # geodata 100k coastline available: https://data.gov.au/dataset/ds-ga-a05f7892-eae3-7506-e044-00144fdd4fa6/
