...
plot_transformations(pred.vars = pred.vars, dat = habi) # not plotting ?
...
# somehow fix the filtering of >90% zeroes, esp. consolidated, check column names
unique.vars.use # All remain


## Run the full subset model selection ----
outdir    <- ("outputs/Habitat_comparison/spatially_balanced/")
