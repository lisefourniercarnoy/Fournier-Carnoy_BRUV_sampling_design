...
file_obs_hab            <- paste0("data/tidy/L01_", study_site, "_tidy_habitat.rds") # Observed habitat values, cleaned in 01_prep
file_bathy_predictors   <- paste0("data/tidy/L01_", study_site, "_bathy_predictors.rds") # made in 01_prep
...
preds <- readRDS(file_bathy_predictors); plot(preds)
...
saveRDS(predictors, file = paste0("data/tidy/L02_", study_site, "_all_predictors.rds")) # Takes a while if running with LiDAR
# ^ needed for 03_gam
